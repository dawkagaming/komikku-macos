...
@pytest.fixture
def starboundscans_server():
    from komikku.servers.starboundscans import Starboundscans
...
def test_starboundscans(starboundscans_server):
    ...
    try:
        response = starboundscans_server.get_manga_data(dict(slug=slug))
    ...
    try:
        response = starboundscans_server.get_manga_chapter_page_image(None, None, None, page)
    except Exception as e:
        response = None
        log_error_traceback(e)
